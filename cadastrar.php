...
?>
	...
	<form action="cadastro.php" name="myForm" method="post" onsubmit="return(validate());">
	<div class="container-fluid">
		<div class="row">
			<div class="well center-block">
				<div class="well-header">
					<h3 class="text-center text-success"> Registre aqui! </h3>
					<hr>
				</div>
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="form-group">
							<div class="input-group">
								...
								<input type="text" placeholder="Nome" name="txtfname" class="form-control">
					...
					<div class="col-xs-12 col-sm-12 col-md-12">
						<div class="form-group">
							<div class="input-group">
								...
								<input type="text" placeholder="Sobrenome" name="txtlname" class="form-control">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="form-group">
							<div class="input-group">
								...
								<input type="password" minlength="8" maxlength="20" placeholder="Senha" name="txtpass" class="form-control">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-12 col-xs-12 col-sm-12">
						<div class="form-group">
							<div class="input-group">
								...
								<input type="number" minlength="10" maxlength="12" class="form-control" name="txtmobile" placeholder="Telefone (XX) X XXXX-XXXX">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-12 col-xs-12 col-sm-12">
						<div class="form-group">
							<div class="input-group">
								...
								<textarea class="form-control" name="txtadd" placeholder="Endereço"></textarea>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-12 col-xs-12 col-sm-12">
						<div class="form-group">
							<div class="input-group">
								...
								<input type="text" name="dob" placeholder="Data de nascimento" class="form-control" id="datepicker">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-12 col-xs-12 col-sm-12">
						<div class="form-group">
							<div class="input-group">
								...
								<input type="number" name="dob" minlength="10" maxlength="12" placeholder="CPF" class="form-control" id="datepicker">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row widget">
					<div class="col-md-12 col-xs-12 col-sm-12">
						<button class="btn btn-warning btn-block"> Cadastrar </button><br>	
